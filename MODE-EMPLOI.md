# Le Prompteur — mode d'emploi

*Document destiné à la personne qui utilise le prompteur en tournage.*
*Aucune connaissance en informatique n'est nécessaire. Aucun texte à taper dans une fenêtre technique.*
*Le boîtier vous est remis déjà installé et prêt à fonctionner.*

---

## En deux phrases

Le Prompteur est un petit boîtier qui affiche votre texte en gros sur un écran, et qui le fait
défiler quand vous appuyez sur une pédale, pour que vous puissiez lire en regardant la caméra.

Vous écrivez ou vous envoyez votre texte depuis votre téléphone, sans internet : le boîtier
fabrique lui-même son propre réseau sans fil, auquel votre téléphone se connecte directement.

> 💡 **Le boîtier ne va jamais sur internet.** Vos textes restent à l'intérieur de l'appareil.
> C'est aussi pour cette raison que, quand votre téléphone est relié au prompteur,
> il n'a plus internet (voir le chapitre 5, étape 4).

---

## ⭐ Si vous ne lisez qu'une page, lisez celle-ci

**Le reste de ce document ne se lit pas d'affilée.** C'est un aide-mémoire : on y va
uniquement quand on cherche quelque chose de précis, ou quand quelque chose cloche.
Au quotidien, tout tient en six gestes.
...
> ⚠️ **Les deux seules choses à ne jamais oublier :**
> 1. Le **mot de passe du réseau Prompteur** est sur la fiche collée au dos du boîtier —
>    il n'existe nulle part ailleurs. **Vérifiez-le la veille, jamais le jour du tournage.**
> 2. Le boîtier **n'a pas de batterie** : il lui faut une prise de courant en permanence.

> 🔁 **Si quelque chose se bloque, le geste qui répare 9 fois sur 10 :** débranchez le
...
| # | Chapitre | Ce que vous y trouvez |
|---|---|---|
| **1** | **Ce que vous avez entre les mains** | Reconnaître chaque appareil et chaque câble |
| **2** | **À la réception du boîtier** | Les vérifications à faire une seule fois, le jour de la remise |
...
| L'élément | À quoi il ressemble | À quoi il sert |
|---|---|---|
...
> 📌 **La règle pour ne pas confondre les câbles :** ce qui vient **du mur** = le courant ;
> ce qui relie **deux appareils entre eux** = l'image.
> Et surtout : **un connecteur qui ne rentre pas est un connecteur qu'on ne force jamais.**
> C'est qu'il n'est pas au bon endroit, ou pas dans le bon sens : retournez-le.

> ⛔ **Ne retirez jamais la petite carte glissée dans la fente du boîtier.** Ce n'est pas une carte
> de photos : c'est la mémoire du boîtier, avec le logiciel et tous vos textes. Sans elle, le
> boîtier ne démarre plus du tout.

---

## 2. À la réception du boîtier

**À faire une seule fois, le jour où l'on vous remet le matériel — surtout pas la veille d'un
tournage.** Ces quelques minutes évitent les deux seules pannes que rien ne permet de réparer
sur un plateau.

- [ ] Le **mot de passe du réseau « Prompteur »** est écrit sur la fiche collée au dos du boîtier
      **ET** recopié dans les notes de mon téléphone (ou mon agenda).
- [ ] Le **numéro de téléphone de la personne qui a installé le boîtier** est écrit sur la fiche
      **ET** enregistré dans mes contacts.
- [ ] Je me suis **connecté une fois** au réseau « Prompteur » avec ce mot de passe, pour vérifier
      qu'il est juste et parfaitement lisible.
- [ ] J'ai noté le **modèle de mon écran 7 pouces**, s'il a **son propre bloc d'alimentation**
      (presque toujours), **où se trouve son bouton**, et **comment choisir son entrée** (le petit
      menu à boutons sur la tranche : il doit être réglé sur **HDMI**).
...
- [ ] J'ai fait un **essai complet à blanc, au moins trois jours avant le tournage** : brancher,
      ...
      pédales, et **lire l'écran à la distance réelle de tournage**.

> ✍️ **À NOTER À DEUX ENDROITS — le mot de passe du réseau.** Il est fabriqué au hasard pendant
> l'installation et **affiché une seule fois**. Il ne peut **pas** être retrouvé après coup, même
> par l'installateur, sans une intervention technique sur le boîtier. S'il n'existe que sur une
> étiquette et que l'étiquette se décolle, plus aucun téléphone ne peut piloter le prompteur.
> **Recopiez-le dans votre téléphone dès aujourd'hui.**

---

## 3. Le courant

> ⚠️ **Le boîtier n'a pas de batterie.** Il lui faut une prise de courant **pendant toute la durée
> du tournage**. Prévoyez une rallonge et **repérez une prise avant de vous installer**.

**Sécuriser les câbles**, en trois gestes qui prennent trente secondes :

- Posez la multiprise **hors du passage**, jamais au milieu du plateau.
- Fixez le câble du boîtier au sol ou à la table (un morceau d'adhésif de tournage suffit).
- **Ne tendez jamais un câble vers le pied du lecteur** : c'est le pied qui bouge, et c'est
  toujours lui qui finit par arracher le câble.
...
> au hasard et les pédales cessent de répondre sans prévenir, en plein direct.
> **Si l'alimentation d'origine est perdue, appelez l'installateur avant le tournage.**

> 🆘 **Pas de prise de courant sur le lieu de tournage ?** Prévenez l'installateur **avant le
> jour J** : il faut une batterie externe adaptée, et tous les modèles ne conviennent pas.
> N'improvisez pas avec une batterie de téléphone.

---

## 4. Brancher

Si vous pouvez laisser le boîtier, l'écran et le pédalier **branchés ensemble dans leur sac**,
faites-le : il n'y aura plus que **les deux alimentations** à remettre — celle de l'écran, puis
celle du boîtier, **dans cet ordre**. Sinon, refaites simplement ce chapitre à chaque montage :
il prend deux minutes.

**L'ordre compte.** Faites-le dans cet ordre exact, alimentation du boîtier **en tout dernier**.

- [ ] **1.** Posez le boîtier et l'écran sur une table, à plat, sans rien poser dessus
      (le boîtier a besoin d'air pour respirer).
      **Posez le boîtier à l'écart du micro** : son ventilateur fait un léger souffle, inaudible
      à un mètre, mais gênant s'il est posé à côté d'un micro-cravate ou sous une perche.
...
- [ ] **3.** Branchez l'autre bout du câble (le connecteur **plus large**) sur l'écran 7 pouces.

- [ ] **4.** Branchez le **câble USB du pédalier** sur une prise USB du boîtier — n'importe
      laquelle des prises rectangulaires, sur l'autre bord.
      Posez la barre **bien à plat, sous le pied qui restera libre**, le câble partant vers le
      boîtier. **Sur un sol lisse** (parquet, carrelage), fixez-la avec deux morceaux d'adhésif
      de tournage ou posez-la sur un tapis antidérapant : sinon elle s'éloigne pendant la prise.
      Faites passer le câble le long d'un pied de table, **sans le tendre**.

- [ ] **5a.** Repérez le **bloc d'alimentation de l'écran** : c'est le petit bloc noir dont le fil
      se termine par un embout **rond** (ou micro-USB), **différent de l'embout ovale du
      boîtier**. Branchez-le sur le secteur, puis sur l'écran.

- [ ] **5b.** **Allumez l'écran.** Son bouton se trouve généralement **sur la tranche ou au dos**,
      et il est souvent minuscule.
      *Ce que vous devez voir : l'écran n'est plus totalement éteint. Il peut afficher un logo,
      un message « pas de signal », un fond bleu : peu importe quoi.*

> ⚠️ **PIÈGE — l'ordre écran / boîtier.** Le boîtier regarde les caractéristiques de l'écran
> **au moment où il démarre**. Un écran allumé après le boîtier peut rester noir.
> Règle simple : **l'écran d'abord, le boîtier ensuite.**

> ⚠️ **PIÈGE — l'entrée de l'écran.** Ces petits écrans ont souvent **plusieurs entrées**
> (HDMI 1, HDMI 2, AV) et un mini-menu à boutons sur la tranche. Resté sur la mauvaise entrée,
> l'écran affiche « pas de signal » ou un fond bleu **quoi que vous branchiez**. Vérifiez aussi
> que la **luminosité n'est pas au minimum**.

- [ ] **6.** Branchez **en tout dernier** l'alimentation du boîtier sur le secteur.
      Le boîtier démarre tout seul : **il n'a pas d'interrupteur marche/arrêt à actionner**.
      *Ce que vous devez voir : selon votre boîtier, une petite lumière peut s'allumer — mais elle
      est parfois invisible à travers le plastique, et ce n'est pas un mauvais signe. Le vrai
      signal, c'est l'écran.*

- [ ] **7.** **Attendez UNE MINUTE COMPLÈTE, montre en main, sans rien toucher et sans rien
      débrancher.** Il est normal que l'écran reste noir ou vide pendant tout ce temps.

**Ce que vous devez voir au bout d'une minute**, et qui prouve que tout va bien :

- l'écran devient **noir et affiche du texte blanc**. Ce peut être un **texte de démonstration**,
...
## 5. À chaque utilisation

Le rituel complet, du matériel posé sur la table au texte qui défile. Comptez 5 minutes.
Cochez au fur et à mesure : sur un tournage, on est toujours interrompu au milieu.

- [ ] **0.** **Si vous avez tout débranché depuis la dernière fois**, refaites d'abord le
      chapitre 4, « Brancher » (deux minutes). Sinon, passez à l'étape 1.

- [ ] **1. Allumez l'écran.** Branchez son bloc d'alimentation (l'embout **rond**, pas l'ovale),
      puis appuyez sur son petit bouton, sur la tranche ou au dos.
      *Ce que vous devez voir : l'écran n'est plus totalement éteint.*

- [ ] **2. Branchez l'alimentation du boîtier** (le gros bloc, embout **ovale**) sur le secteur.
      Le boîtier démarre tout seul.
      **Attendez UNE MINUTE COMPLÈTE, montre en main, sans rien toucher et sans rien débrancher.**
      *Ce que vous devez voir au bout de cette minute : l'écran devient noir avec du gros texte
...
- [ ] **3. Vérifiez que les pédales répondent.** Appuyez sur la **pédale de droite et gardez le
      ...
      *Ce que vous devez voir : le texte monte, et le repère en haut à droite passe de `⏸` à `▶︎`.
      Dès que vous relâchez, le texte s'arrête et le repère revient à `⏸`.*
...
- [ ] **4. Connectez votre téléphone au réseau « Prompteur ».** Sur votre téléphone, ouvrez la
      ...
      (avec un P majuscule). Saisissez le mot de passe noté sur la fiche collée au dos du boîtier.
      **Recopiez-le exactement, majuscules et minuscules comprises** : c'est la première cause
      d'échec.
      *Ce que vous devez voir : votre téléphone indique qu'il est connecté à « Prompteur ».*

> 🆘 **Si la fiche est vide, ou si le mot de passe est refusé** : ne cherchez pas, **il n'y a pas
> de solution sur place**. Ce mot de passe n'existe nulle part ailleurs dans le boîtier.
> Appelez la personne qui a installé le boîtier (numéro sur la fiche), ou regardez si vous l'aviez
> recopié dans les notes de votre téléphone (chapitre 2).
> **C'est à vérifier impérativement la veille, jamais le jour J.**

> ⚠️ **PIÈGE — le message « ce réseau n'a pas d'accès à Internet ».** C'est **normal et voulu** :
> le boîtier ne va pas sur internet. Mais votre téléphone, lui, va vouloir vous « rendre service »
> et repartir tout seul sur la 4G — et vous perdrez la télécommande, parfois en plein tournage.
>
> - **Sur Android** : quand l'avertissement apparaît, répondez **Oui / Rester connecté**
>   (l'intitulé exact change selon les téléphones : c'est toujours la réponse qui **garde**
>   le réseau).
> - **Sur iPhone** : ignorez l'alerte, puis allez dans **Réglages → Données cellulaires** et
...
> qu'il n'a pas. Tapez bien le début `http://`.
>
> 💡 **À faire une fois pour toutes** : dès que la page est ouverte, enregistrez-la en favori,
> ou mieux, ajoutez-la en **raccourci sur l'écran d'accueil** de votre téléphone.
> Vous n'aurez plus jamais à taper cette adresse.

- [ ] **6. Envoyez votre texte.** Dans l'onglet **Texte**, remplissez le champ **Titre**, collez
      ou écrivez votre texte dans la grande zone, puis appuyez sur le bouton vert
      **« Envoyer à l'écran »**. *(Le détail des trois façons d'apporter un texte est au
      chapitre 6.)*
      *Ce que vous devez voir : un petit message **« Texte envoyé à l'écran ✓ »** apparaît une
      seconde en bas de l'écran du téléphone, ET le texte apparaît sur le grand écran en moins
...
> à quelqu'un : **les pédales continuent de fonctionner toutes seules**. Le téléphone n'est utile
> que pour changer le texte, la vitesse ou les réglages.

- [ ] **7. Lisez au pied.** Appuyez sur la pédale de droite et gardez le pied appuyé : le texte
      monte. Relâchez : il s'arrête.
...
5. Si vous voulez le garder pour plus tard, appuyez **aussi** sur **« Enregistrer »**.

*Ce que vous devez voir : le message « Texte envoyé à l'écran ✓ », puis, après « Enregistrer »,
...
> 📌 **La clé USB se branche sur le BOÎTIER, jamais sur le téléphone.** C'est le boîtier qui la
> lit ; le téléphone ne fait que commander la recherche.

1. Branchez la clé sur une prise USB du **boîtier**, et attendez 5 secondes.
2. Sur le téléphone : onglet **Texte**, carte **« Importer »**, bouton **« Clé USB »**.
3. Le message **« Recherche de clés USB… »** apparaît. **Patientez** : l'analyse peut prendre
   plusieurs secondes sans aucun signe visible. **N'appuyez pas cinq fois sur le bouton.**
...
Onglet **Texte**, carte **« Mes textes enregistrés »** tout en bas : chaque ligne porte le nom
...
|---|---|
| Vous **maintenez la pédale de DROITE** enfoncée | Le texte **avance** (il monte). Le repère en haut à droite passe à `▶︎`. |
| Vous **relâchez** | Le texte **s'arrête net**, immédiatement. Le repère repasse à `⏸`. |
| Vous **maintenez la pédale de GAUCHE** enfoncée | Le texte **recule**. Le repère affiche `◀︎`. |

**Le pied reste appuyé pendant toute la lecture** : c'est exactement ce qui vous donne l'arrêt
immédiat, et c'est la grande sécurité du système. Mais c'est aussi fatigant.
...
### Ce qui se passe quand le texte est fini
...
- **Enregistrez-les avec des titres numérotés** : `Seq 1 intro`, `Seq 2 interview`,
  `Seq 3 conclusion`…
- Entre deux prises, vous **chargez** celui dont vous avez besoin en une seconde (onglet
  **Texte**, carte « Mes textes enregistrés », bouton bleu **« Charger »**), au lieu de chercher
  votre place.

> 💡 **Écrivez `FIN` sur la dernière ligne de chaque séquence.** Vous verrez arriver la fin du
> texte au lieu d'être surpris par l'arrêt.
...
> c'est normal sur un écran de 7 pouces, plus le texte est gros, moins il tient de lignes.
...
Carte **« Affichage »**. Elle contient **deux interrupteurs de miroir, collés l'un à l'autre** :

- **« Miroir horizontal (vitre sans tain) »** : il retourne le texte **de gauche à droite**,
  pour la lecture **dans une vitre**.
- **« Miroir vertical »** : il retourne le texte **de haut en bas**. Il ne sert que pour des
  montages très particuliers. **Vous n'en aurez normalement jamais besoin : laissez-le éteint.**

**À quoi sert le miroir horizontal :** sur certains montages de tournage, l'écran est posé à plat
et son image se reflète dans une **vitre inclinée** placée devant l'objectif de la caméra. Comme
dans un miroir, le texte s'y voit **à l'envers**. L'interrupteur retourne donc le texte à
l'avance, pour qu'il redevienne parfaitement lisible **dans la vitre**.

- **Vous lisez directement l'écran** (posé sous ou à côté de la caméra) : **laissez les deux
...
### Si le pédalier lâche (câble arraché, pédale cassée, prise morte)

Le pédalier n'est rien d'autre qu'**un clavier déguisé** : il envoie les touches **Flèche bas**
(avancer) et **Flèche haut** (reculer). **N'importe quel clavier USB ordinaire branché sur le
boîtier fait exactement le même travail** — et même davantage.

1. Branchez un **clavier USB** sur une prise USB du boîtier.
2. Si une souris est branchée (ou si votre écran est tactile), **cliquez une fois sur l'écran
   noir**, puis essayez.
3. **Flèche bas maintenue** = la pédale droite (le texte avance).
   **Flèche haut maintenue** = la pédale gauche (le texte recule).

| Touche du clavier | Ce qu'elle fait |
|---|---|
...
### Si le téléphone lâche (déchargé, en panne, ou parti avec son propriétaire)

**Une fois le texte affiché à l'écran, le téléphone ne sert plus à rien pendant la prise.**
Les pédales fonctionnent seules, même téléphone éteint. Le téléphone n'est utile que pour
**changer** le texte, la vitesse ou les réglages.
...
Le Raspberry Pi qui se trouve à l'intérieur possède **un petit bouton d'arrêt, sur la carte, juste
à côté de la prise d'alimentation**. Selon le boîtier plastique, il est **accessible ou non**.
Faites-le vérifier une fois par l'installateur et notez la réponse (chapitre 2).

**Si le bouton est accessible** — c'est la meilleure façon d'éteindre :

- [ ] **1.** Vérifiez que **plus rien n'est en cours** : le repère en haut à droite de l'écran
...
**Si le bouton n'est pas accessible** sur votre boîtier, on éteint en débranchant — mais
**jamais n'importe quand** :

- [ ] **1.** Vérifiez que le repère en haut à droite affiche `⏸` et que rien n'est en cours
      (ni envoi de texte, ni import).
- [ ] **2.** Attendez **5 secondes** sans rien toucher.
- [ ] **3.** Débranchez l'alimentation du boîtier.
- [ ] **4.** Éteignez et débranchez l'écran.

> ⚠️ **PIÈGE — débrancher pendant que le boîtier travaille.** Ne débranchez jamais pendant l'envoi
> d'un texte, pendant un import, ni dans la première minute après l'allumage : vous risqueriez
...
- [ ] Débranchez **l'alimentation en dernier**, une fois le boîtier arrêté.
- [ ] Retirez le **câble d'écran bien droit, sans forcer et sans tirer en biais** : son petit
      connecteur est la pièce la plus fragile de l'ensemble.
- [ ] **Enroulez les câbles sans serrer** ; ne les nouez pas autour des blocs d'alimentation.
- [ ] Transportez le boîtier et l'écran **à plat**, et rangez **l'alimentation de l'écran avec
      l'écran** : c'est la pièce qu'on oublie le plus souvent.
- [ ] **Ne retirez jamais la petite carte mémoire** glissée dans la fente du boîtier.
...
- [ ] **Mon plan B est prêt** : mon texte **imprimé en gros caractères**, ou ouvert en très grand
      sur une tablette. Si le boîtier ne démarre pas, le tournage a quand même lieu.

### Dans le sac

- [ ] Le **boîtier**
- [ ] **Son** alimentation (le gros bloc, embout ovale)
- [ ] L'**écran** 7 pouces
- [ ] **Son alimentation à lui** (embout rond — c'est la pièce la plus souvent oubliée)
- [ ] Le **câble d'écran**
- [ ] Le **pédalier**
- [ ] La **souris USB**
- [ ] Le **clavier USB de secours**
- [ ] La **clé USB de secours**, avec les textes du tournage **à la racine**
- [ ] Une **rallonge ou une multiprise**
- [ ] La **fiche** du boîtier — ou **une photo de la fiche** prise avec le téléphone
- [ ] *(Si l'installateur en a préparé une)* la **deuxième carte mémoire**

### Sur place, avant de filmer

- [ ] J'ai **repéré une prise de courant** et posé la multiprise **hors du passage** ; le câble du
      boîtier est fixé et ne passe pas sous le pied du lecteur.
- [ ] J'ai **branché et allumé** dans le bon ordre : écran d'abord, boîtier ensuite.
...
# ✂️ FICHE À DÉCOUPER ET COLLER SUR LE BOÎTIER

> **📋 À l'attention de la personne qui installe le boîtier :**
> *à remplir, découper et coller au dos du boîtier **avant** de le remettre.
> Le mot de passe du réseau n'est affiché qu'une seule fois pendant l'installation :
> **s'il n'est pas recopié ici, il est perdu.***

> ### 📻 LE PROMPTEUR
>
> **Réseau sans fil du boîtier :** `Prompteur` *(avec un P majuscule)*
>
> **Mot de passe :** `_________________________________`
>
> *(Respecter les majuscules et les minuscules à la saisie.)*
>
> ✍️ **À NOTER AILLEURS AUSSI : recopiez ce mot de passe dans votre téléphone ou votre agenda.
...
> → attendre le message **« Texte envoyé à l'écran ✓ »**.
>
> **3.** **Pédale droite maintenue = le texte avance.** Relâcher = ça s'arrête.
...
*Ce document décrit l'utilisation quotidienne du boîtier déjà installé. L'installation initiale
et le détail technique font l'objet de documents séparés (`README.md`, `MISE-EN-ROUTE.md` et
`PROCEDURE-INSTALLATION.md`), qui ne concernent pas l'utilisateur.*
